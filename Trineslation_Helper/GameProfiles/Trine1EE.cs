...
{
    public class Trine1EE : IGameProfile
    {
        ...
        {
            { $@"_enchanted_edition_\data\launcher\locale\{GettextMoLang}\game_launcher.mo", FileType.GettextMo },
            { @"_enchanted_edition_\data\launcher\locale\launcher_base_locales.fbll", FileType.Fbll }
        };
