...
{
    public class Trine2 : IGameProfile
    {
        ...
        public Dictionary<string, FileType> GameFolderStructure => new Dictionary<string, FileType>
        {
            ...
            { $@"data\locale\subtitles\{LuaStringsLang}\dlc1_locales.lua", FileType.LuaStrings },
        ...
        {
            { $@"data\launcher\locale\{GettextMoLang}\trine2_launcher.mo", FileType.GettextMo },
