...
{
    public class Trine3 : IGameProfile
    {
        ...
        public Dictionary<string, FileType> GameFolderStructure => new Dictionary<string, FileType>
        {
            ...
            { $@"data\locale\gui\{LuaStringsLang}\menu\batterystatusmessage.lua", FileType.LuaStrings },
            ...
            { $@"data\locale\gui\{LuaStringsLang}\menu\hintscreen.lua", FileType.LuaStrings },
            ...
            { $@"data\locale\gui\{LuaStringsLang}\menu\playablelevelselectionmenu.lua", FileType.LuaStrings },
            ...
            { $@"data\locale\gui\{LuaStringsLang}\menu\mainmenu\levelcheckpointmenu.lua", FileType.LuaStrings },
            ...
            { $@"data\locale\subtitles\{LuaStringsLang}\design_tutorial.lua", FileType.LuaStrings },
